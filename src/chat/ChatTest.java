...
public class ChatTest{
   ...
   public void startChat() {
	   ...
	   /*
	   Student s1 = new Student("student_1 1", "email_1", 5);
	   Student s2 = new Student("student_2 2", "email_2", 6);
	   Instructor i1 = new Instructor("instructor_1 1", "email_3", 7);
	   Instructor i2 = new Instructor("instructor_2 2", "email_4", 8);
	   */
	   ...
	   assertEquals(true, list1.equals(list5)); //student is in the class
	   assertEquals(true, list2.equals(list6)); //instructor can message student
	   assertEquals(true, list3.equals(list7)); //student not in the class
	   assertEquals(true, list4.equals(list8)); //instructors not in the same class
   }
   ...
   public void validateUsers() {
	   //DatabaseUtil.addNewClass(c, i1.getUserId());
